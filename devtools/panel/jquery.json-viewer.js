...
(function($) {
   ...
   */
  $.fn.jsonViewer = function(json, placeholder, options) {
    ...
    return this.each(function() {
      ...
      $(this).on('click', 'a.json-toggle', function() {
        ...
        if (target.is(':visible')) {
          ...
          var countFmt = count + (count > 1 ? ' items' : ' item');
          if (target.parent().hasClass("json-document")) {
            target.after('<a href class="json-placeholder">' + placeholder + '</a>');
          } else {
            target.after('<a href class="json-placeholder">' + countFmt + '</a>');
          }
        }
        return false;
      });
